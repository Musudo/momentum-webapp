...
type TExtendedTreeItemProps = {
    color?: TColor;
    id: string;
    label: string;
};

const ITEMS: TreeViewBaseItem<TExtendedTreeItemProps>[] = [
    {
        id: '1',
        label: 'Main',
        children: [
            {id: '1.1', label: 'Dashboard', color: 'blue'},
            {id: '1.2', label: 'Activities', color: 'blue'},
            {id: '1.3', label: 'Contacts', color: 'blue'},
        ],
    },
    {
        id: '2',
